    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">热咖啡与白猫</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="page-scroll" href="#portfolio">一场旅行，一段故事</a>
                    </li>
                    <li>
                        <a class="page-scroll" href="#more">了解更多</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <h2 class="section-heading">在这里你将找到与众不同的美食</h2>
                    <hr class="light">
                    <p class="text-faded">这个世界有些美食是精心烹制的,有些美食却是意外产生的。你有没有想过当你品尝一块提拉米苏或一杯爱尔兰咖啡时,其实你品味的还有其背后的美食故事?</p>
                    <a href="#services" class="page-scroll btn btn-default btn-xl sr-button">了解更多</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">献上最用心的服务</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>积分制</h3>
                        <p class="text-muted">消费得积分可更换精美礼品</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>更用心</h3>
                        <p class="text-muted">用心奉上最好的服务</p>
                    </div>
                </div>
            </div>
        </div>

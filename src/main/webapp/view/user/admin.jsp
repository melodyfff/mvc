...
<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #1aa094;">
    ...
    <div class="layui-body" style="bottom: 0;border-left: solid 2px #1AA094;" id="admin-body">
        <div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab">
            ...
            <div class="layui-tab-content" id="content" style="min-height: 150px; padding: 20px 20px 20px 20px;">
                <blockquote class="layui-elem-quote">欢迎使用---KMU</blockquote>
            </div>
        </div>
    </div>
    ...
    <script>
        layui.use(['layer', 'form','laypage'] ,function () {
            ...
            $(document).ready(function() {
                <%--$.get('${pageContext.request.contextPath}/admin/usermanage',function (data) {--%>
